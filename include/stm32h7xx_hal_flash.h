...
#define __HAL_FLASH_ENABLE_IT(__INTERRUPT__) (IS_FLASH_IT_BANK1(__INTERRUPT__) ? __HAL_FLASH_ENABLE_IT_BANK1(__INTERRUPT__) : __HAL_FLASH_ENABLE_IT_BANK2(__INTERRUPT__))
#else
...
#if defined(DUAL_BANK)
#define __HAL_FLASH_DISABLE_IT(__INTERRUPT__) (IS_FLASH_IT_BANK1(__INTERRUPT__) ? __HAL_FLASH_DISABLE_IT_BANK1(__INTERRUPT__) : __HAL_FLASH_DISABLE_IT_BANK2(__INTERRUPT__))
#else
...
#if defined(DUAL_BANK)
#define __HAL_FLASH_CLEAR_FLAG(__FLAG__) (IS_FLASH_FLAG_BANK1(__FLAG__) ? __HAL_FLASH_CLEAR_FLAG_BANK1(__FLAG__) : __HAL_FLASH_CLEAR_FLAG_BANK2(__FLAG__))
#else
