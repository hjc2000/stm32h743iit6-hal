 ...
 */
#if defined(DUAL_BANK)
#define __HAL_FLASH_SET_PSIZE(__PSIZE__, __BANK__) (((__BANK__) == FLASH_BANK_1) ? MODIFY_REG(FLASH->CR1, FLASH_CR_PSIZE, (__PSIZE__)) : MODIFY_REG(FLASH->CR2, FLASH_CR_PSIZE, (__PSIZE__)))
#else
 ...
 */
#if defined(DUAL_BANK)
#define __HAL_FLASH_GET_PSIZE(__BANK__) (((__BANK__) == FLASH_BANK_1) ? READ_BIT((FLASH->CR1), FLASH_CR_PSIZE) : READ_BIT((FLASH->CR2), FLASH_CR_PSIZE))
#else
